...
一个使用 Python 虚拟环境 + PySide6 的透明桌面宠物库，当前角色为浊心斯卡蒂（默认基建），可以显示 Codex 当前是否运行以及最近的运行状态。
...
- 右键：坐下 / 放松 / 睡觉 / 桌宠库 / 解锁或锁定拖动 / 设置 / 放大 / 缩小 / 退出
- 右键菜单可单独开关“迷你模式”和“全屏应用时自动隐藏”
- 右键“退出”会真正关闭桌宠，即使 ChatGPT / Codex 还在运行也不会被重新拉起，直到应用下次启动
